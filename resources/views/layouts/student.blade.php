...
<body class="app sidebar-fixed aside-menu-off-canvas aside-menu-hidden header-fixed footer-fixed">
    <header class="app-header navbar">
        ...
        <!-- end hamburger -->
        <a class="navbar-brand" href="{{ route('student') }}"> <strong>Student Section</strong></a>
            ...
            <nav class="sidebar-nav" id="sidebar-nav-scroller">
                <ul class="nav">
                    <li class="nav-item nav-dropdown">
                        <a class="nav-link nav-dropdown-toggle" href="{{ route('student') }}">
                    ...
                    <li class="nav-item nav-dropdown">
                      <a href="#" class="nav-link nav-dropdown-toggle">
                        <i class="mdi mdi-account-check"></i> REGISTRATION
                      </a>
                        <ul class="nav-dropdown-items">
                          <li class="nav-item">
                            <a href="{{ route('course_registration.create') }}" class="nav-link">Course registration</a>
                          </li>
                          <li class="nav-item">
                            <a href="{{ route('form_b.index') }}" class="nav-link">My FORM B</a>
                          </li>
                          <li class="nav-item">
                              <a href="{{ route('apply_clearance.index') }}" class="nav-link">Clearance Form</a>
                          </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item nav-dropdown">
                        <a href="#" class="nav-link nav-dropdown-toggle">
                          <i class="mdi mdi-account-check"></i> COMPLAINT
                        </a>
                          <ul class="nav-dropdown-items">
                            <li class="nav-item">
                              <a href="{{ route('complaint.create') }}" class="nav-link">Write a complaint</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('complaint.index') }}" class="nav-link">List my complaint(s)</a>
                            </li>
                          </ul>
                      </li>
                </ul>
