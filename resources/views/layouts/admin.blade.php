...
<body class="app sidebar-fixed aside-menu-off-canvas aside-menu-hidden header-fixed footer-fixed">
    <header class="app-header navbar">
        ...
        <!-- end hamburger -->
        <a class="navbar-brand" href="{{ route('admin') }}"> <strong>Admin Dashboard</strong></a>
            ...
            <nav class="sidebar-nav" id="sidebar-nav-scroller">
                <ul class="nav">
                    <li class="nav-item nav-dropdown">
                        <a class="nav-link nav-dropdown-toggle" href="{{ route('admin') }}">
                    ...
                    <li class="nav-item nav-dropdown">
                      <a href="#" class="nav-link nav-dropdown-toggle">
                        <i class="mdi mdi-account-multiple"></i>Manage Students
                      </a>
                        <ul class="nav-dropdown-items">
                          <li class="nav-item">
                            <a href="{{ route('manage_student.create') }}" class="nav-link">Add a Student</a>
                          </li>
                          <li class="nav-item">
                            <a href="{{ route('manage_student.index') }}" class="nav-link">List of students</a>
                          </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item nav-dropdown">
                      <a href="#" class="nav-link nav-dropdown-toggle">
                        <i class="mdi mdi-account-check"></i> Manage Users
                      </a>
                        <ul class="nav-dropdown-items">
                          <li class="nav-item">
                            <a href="{{ route('user_management.index') }}" class="nav-link">List users</a>
                          </li>
                          <li class="nav-item">
                            <a href="{{ route('user_management.create') }}" class="nav-link">Add user</a>
                          </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item nav-dropdown">
                        <a href="#" class="nav-link nav-dropdown-toggle">
                          <i class="mdi mdi-account-network"></i> Manage Teachers
                        </a>
                          <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a href="{{ route('teacher.index') }}" class="nav-link">List teacher</a>
                            </li>
                            <li class="nav-item">
                              <a href="{{ route('teacher.create') }}" class="nav-link">Add teacher</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('assign_course.create') }}" class="nav-link">Assign courses</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('assign_course.index') }}" class="nav-link">Courses Teach</a>
                            </li>
                          </ul>
                    </li>
                    ...
                    <li class="nav-item nav-dropdown">
                        <a href="#" class="nav-link nav-dropdown-toggle">
                          <i class="mdi mdi-book"></i> Manage Courses
                        </a>
                          <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a href="{{ route('course.index') }}" class="nav-link">List courses</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('course.create') }}" class="nav-link">Add course</a>
                            </li>
                          </ul>
                    </li>
                    ...
                    <li class="nav-item nav-dropdown">
                      <a href="#" class="nav-link nav-dropdown-toggle">
                        <i class="mdi mdi-av-timer"></i> Manage Attendance
                      </a>
                      <ul class="nav-dropdown-items">
                        <li class="nav-item">
                          <a href="#" class="nav-link">List Attendance</a>
                        </li>
                      </ul>
                    </li>
                    ...
                    <li class="nav-item nav-dropdown">
                      <a href="#" class="nav-link nav-dropdown-toggle">
                        <i class="mdi mdi-school"></i> Manage school
                      </a>
                      <ul class="nav-dropdown-items">
                        <li class="nav-item">
                          <a href="{{ route('school.create') }}" class="nav-link">Create school</a>
                        </li>
                        <li class="nav-item">
                          <a href="{{ route('department.create') }}" class="nav-link">Create department</a>
                        </li>
                        <li class="nav-item">
                          <a href="{{ route('speciality.create') }}" class="nav-link">Create Speciality</a>
                        </li>
                      </ul>
                    </li>
                    ...
                    <li class="nav-item nav-dropdown">
                        <a href="#" class="nav-link nav-dropdown-toggle">
                          <i class="mdi mdi-av-timer"></i> Manage Complaints
                        </a>
                        <ul class="nav-dropdown-items">
                          <li class="nav-item">
                            <a href="{{ route('manageComplaint.index') }}" class="nav-link">List Complaint</a>
                          </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item nav-dropdown">
                        <a href="#" class="nav-link nav-dropdown-toggle">
                            <i class="mdi mdi-av-timer"></i> Manage Clearance
                        </a>
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a href="{{ route('clearance_form.index') }}" class="nav-link">Clearance form</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item nav-dropdown">
                      <a href="#" class="nav-link nav-dropdown-toggle">
                        ...
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a href="{{ route('semester.create') }}" class="nav-link">Semester</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('type_course.create') }}" class="nav-link">Type of courses</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('image.create') }}" class="nav-lin">Rooms</a>
                            </li>
                        </ul>
                    </li>
                </ul>
    ...
    <a href="{{ route('admin') }}" class="text-theme">Student Management System</a> © 2019 Flavie DT.
