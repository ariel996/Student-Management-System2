                    ...
                    <form action="{{ route('school.update', [$school->id]) }}" method="post">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="school_code" id="school_code" placeholder="Enter school code" value="{{ $school->school_code }}" required />
                                    </div>
                                </div>
                            </div><!-- end of row -->
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" class="form-control" name="school_name" id="school_name" value="{{ $school->school_name }}" placeholder="Enter school name" required />
                                    </div>
                                </div>
                            </div><!-- end of row -->
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <textarea name="school_description" id="description" cols="10" rows="3" class="form-control" required>{{ $school->school_description }}</textarea>
                                    </div>
                                </div>
                            </div><!-- end of row -->
