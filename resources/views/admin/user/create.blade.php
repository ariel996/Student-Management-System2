        ...
        <div class="row">
            <div class="col-md-12 col-sm-6 col-xs-4 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('user_management.store')}}" method="post" class="form-horizontal">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" id="email" class="form-control" placeholder="enter a valid email" required/>
                            </div>
